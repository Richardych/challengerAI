...
deploy=root + 'models/ResNet/tmp/ResNet-50-deploy.prototxt'    	#deploy文件 
caffe_model=root + 'models/ResNet/tmp/resnet_iter_40000.caffemodel'  	#训练好的 caffemodel 
labels_filename = root +'models/ResNet/tmp/scene_classes.csv'    		#类别名称文件，将数字标签转换回类别名称  
...
def Test(img,net):
    ...
    print img
    print cls
    f=file(root+"models/ResNet/tmp/resultlabelres50zscore.txt","a+")

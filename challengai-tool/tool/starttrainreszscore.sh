...
./build/tools/caffe train -solver /home/yuchaohui/ych/caffe_ych/models/ResNet/tmp/solver.prototxt -weights /home/yuchaohui/ych/caffe_ych/models/ResNet/ResNet-50-model.caffemodel -gpu 0
